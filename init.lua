...
-- NOTE: this part is from nvim-tree setup
...
require('lazy').setup({
  ...
  {
    -- 'catppuccin/nvim', init = function() vim.cmd.colorscheme 'catppuccin' end,
    -- 'bluz71/vim-moonfly-colors', init = function() vim.cmd.colorscheme 'moonfly' end,
  ...
  { -- displays current block(s) start text when scrolled above viewport (useful in huge blocks)
